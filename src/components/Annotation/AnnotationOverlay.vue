...
<template>
  <div class="annotation-overlay">
    ...
    >
      ...
      <div
        v-if="!editMode"
        class="annotation-fab annotation-fab-edit"
        @click.stop="toggleEditMode"
        title="进入编辑模式 (Ctrl+Shift+A)"
      >
    ...
    <div v-if="editMode" class="annotation-toolbar">
      ...
      <span class="toolbar-hint">点击页面添加标注 (Ctrl+Shift+A 切换)</span>
      <button class="toolbar-btn toolbar-btn-exit" @click="toggleEditMode">退出编辑</button>
    </div>

    <!-- 点击页面添加标注 (Ctrl+Shift+A 切换)（编辑模式下）-->
